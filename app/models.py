...
class HomeShow(db.Model):
    ...
    trackid = db.Column(db.String(50))
    ...
    marketprice1 = db.Column(db.String(10))
    ...
    marketprice2 = db.Column(db.String(10))
    ...
    price3 = db.Column(db.String(10))
    marketprice3 = db.Column(db.String(10))
...
class MarketFoodType(db.Model):
    __tablename__ = "axf_foodtypes"
    id = db.Column(db.Integer,primary_key=True,autoincrement=True)
    typeid = db.Column(db.String(16))
...
class MarketGoods(db.Model):
    ...
    marketprice = db.Column(db.Float,default=0.0)
    categoryid = db.Column(db.String(16))
    childcid = db.Column(db.String(20))
...
class CartModel(db.Model):
    __tablename__ = "axf_cartmodel"
    id = db.Column(db.Integer,primary_key=True,autoincrement=True)
    c_user = db.Column(db.ForeignKey(UserModel.id)) # 关联用户表
...
class OrderModel(db.Model):
    # 订单号
    __tablename__ = "axf_ordermodel"
    id = db.Column(db.Integer,primary_key=True,autoincrement=True)
    o_num = db.Column(db.String(64))
    o_user = db.Column(db.ForeignKey(UserModel.id))
    o_status = db.Column(db.Integer,default=0)
    o_datatime = db.Column(db.DateTime,default=datetime.now)


# 订单-商品 表
class OrderGoodsModel(db.Model):
    __tablename__ = "axf_ordergoodsmodel"
    id = db.Column(db.Integer,primary_key=True,autoincrement=True)
    og_order = db.Column(db.ForeignKey(OrderModel.id))
    og_num = db.Column(db.Integer,default=1)
    og_goods = db.Column(db.ForeignKey(MarketGoods.id))
#
#
